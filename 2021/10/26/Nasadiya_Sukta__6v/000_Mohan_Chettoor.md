...
+++
[[Mohan Chettoor	2021-10-26, 20:32:20 [Source](https://groups.google.com/g/samskrita/c/6vn3Q_LjlBk)]]



  

Nasadiya Sukta as copied from the Rig veda sayana bhashyam is reproduced below in editable format for the use of all:

Note: *This copy is based on the methodology adopted by me from the photo image of each PDF pge. Some errors are likely to occur as some letters may be wrongly recognised and copied. Users are advised to refer to the original text to avoid mistakes. An English translation of the suktha is available in wikipedia.*
